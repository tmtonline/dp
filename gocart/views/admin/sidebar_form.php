<?php echo form_open($this->config->item('admin_folder').'/sidebar/form/'.$id); ?>
	...
	<div class="tab-content">
		<div class="tab-pane active" id="content_tab">
			<fieldset>
				...
				<label for="content"><?php echo lang('left_content');?></label>
				<?php
				$data	= array('name'=>'left_content', 'class'=>'redactor' ,'value'=>set_value('left_content', $left_content));
				echo form_textarea($data);
				?>
				
				<label for="content"><?php echo lang('right_content');?></label>
				<?php
				$data	= array('name'=>'right_content', 'class'=>'redactor' ,'value'=>set_value('right_content', $right_content));
				echo form_textarea($data);
				?>
