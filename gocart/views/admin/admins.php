		...
		<tr>
			...
			<td>
				<div class="btn-group" style="float:right;">					
					<a class="btn" href="<?php echo site_url($this->config->item('admin_folder').'/leaves/leave_adjustment_form/'.$admin->id);?>"><i class="icon-user"></i> <?php echo lang('leave_adjustment');?></a>	
