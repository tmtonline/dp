...
<?php echo form_open_multipart($this->config->item('admin_folder').'/galleries/form/'.$id); ?>
...
<div class="tabbable">
	...
	<div class="tab-content">
		...
		<div class="tab-pane" id="image_tab">
			...
			<?php if($id && $image != ''):?>
				<div style="text-align:center; padding:5px; border:1px solid #ccc;"><img src="<?php echo base_url('uploads/gallery/full/'.$image);?>" alt="current"/><br/><?php echo lang('current_file');?></div>
			<?php endif;?>			
		</div>
