...
$banner_text	= array('name'=>'banner_text', 'value' => set_value('banner_text', $banner_text));
...
<?php echo form_open_multipart(config_item('admin_folder').'/banners/banner_form/'.$banner_collection_id.'/'.$banner_id); ?>
	...
	<label for="link"><?php echo lang('banner_text');?> </label>
	<?php echo form_input($banner_text); ?>
